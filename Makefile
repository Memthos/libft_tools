...
OBJS_DIR=objs/
HEADERS=includes/
SRCS=ft_atoi.c ft_bzero.c ft_calloc.c ft_free_tab.c ft_isalnum.c ft_isalpha.c \
	...
	ft_putnbr_fd.c ft_putstr_fd.c ft_split.c ft_strchr.c ft_strcmp.c ft_strdup.c \
	ft_striteri.c ft_strjoin_sep.c ft_strjoin.c ft_strlcat.c ft_strlcpy.c \
